...
CREATE TABLE alarm_logs (
    ...
    camera_code     VARCHAR(64)     NULL COMMENT 'Camera code',
    ...
    detection_model VARCHAR(32)     NULL COMMENT 'AI model tag',
    detection_label VARCHAR(128)    NULL COMMENT 'Model output label',
    bbox_json       JSON            NULL COMMENT 'Detection bbox [x1,y1,x2,y2]',
    raw_result      JSON            NULL COMMENT 'Raw model output item',
    ...
    KEY idx_alarm_camera_code (camera_code),
    KEY idx_alarm_detection_model (detection_model),
